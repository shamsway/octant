...
- **Domain:** lab.example.com with Cloudflare certresolver configured and working
...
- **DNS tiers:** sslip.io default + Cloudflare opt-in documented; configured for lab.example.com
