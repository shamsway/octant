...
All services are accessible at `https://{service}.lab.shamsway.net`.
...
**URL:** https://uptimekuma.lab.shamsway.net
...
|---|---|---|---|
| Grafana | HTTP(s) | `https://grafana.lab.shamsway.net` | 60s |
| Prometheus | HTTP(s) | `https://prometheus.lab.shamsway.net/-/healthy` | 60s |
| Nomad | HTTP(s) | `https://nomad.lab.shamsway.net` | 60s |
| Consul | HTTP(s) | `https://consul.lab.shamsway.net` | 60s |
| Traefik | HTTP(s) | `https://traefik.lab.shamsway.net` | 60s |
...
receivers:
  - name: default
    webhook_configs:
      - url: 'https://ntfy.lab.shamsway.net/octant-alerts'
```
...
**URL:** https://gatus.lab.shamsway.net
...
**URL:** https://prometheus.lab.shamsway.net/targets
...
**URL:** https://traefik.lab.shamsway.net (port 9002 via HAProxy)
...
|---|---|---|---|
| Prometheus | `prometheus.service.consul:9091` | `https://prometheus.lab.shamsway.net` | 9091 |
| Grafana | `grafana.service.consul:3000` | `https://grafana.lab.shamsway.net` | 3000 |
| Loki | `loki.service.consul:3100` | `https://loki.lab.shamsway.net` | 3100 |
| Tempo | `tempo.service.consul:3200` | `https://tempo.lab.shamsway.net` | 3200 |
| Alertmanager | `alertmanager.service.consul:9093` | `https://alertmanager.lab.shamsway.net` | 9093 |
| Alloy | `alloy.service.consul:12345` | (not exposed) | 12345 |
| Gatus | `gatus.service.consul:8080` | `https://gatus.lab.shamsway.net` | 8080 |
| Uptime Kuma | `uptimekuma.service.consul:3001` | `https://uptimekuma.lab.shamsway.net` | 3001 |
| Traefik | `traefik.service.consul` | `https://traefik.lab.shamsway.net` | 80/443/8082/9002 |
