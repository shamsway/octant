...
- Add requirements role
  - `ansible-playbook octant.yml -i inventory/groups.yml -l [host] --tags "requirements"`
...
- Add consul role
  - `ansible-playbook octant.yml -i inventory/groups.yml -l [host] --tags "consul"`
- Add nomad role
  - `ansible-playbook octant.yml -i inventory/groups.yml -l [host] --tags "consul"`
...
- Clean up old data
  - `nomad system gc`
- Add restic role
  - `ansible-playbook octant.yml -i inventory/groups.yml -l [host] --tags "restic"`
